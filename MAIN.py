...
def mod1():
    os.startfile("dist\\Mod1.exe")

def mod2():
    os.startfile("dist\\Mod2.exe")
    
def mod3():
    os.startfile("dist\\Mod3.exe")
    
def mod4():
    os.startfile("dist\\Mod4.exe")
    
def mod5():
    os.startfile("dist\\Mod5.exe")
    
def mod6():
    os.startfile("dist\\Mod6.exe")
...
Button(text="Motion Detector", command=mod4, activebackground='green', highlightcolor='yellow', bd=6, bg='black', fg='white', font=('Megrim', 20, 'bold'), relief='raised',height=1, width=15).place(x=750, y = 120)
